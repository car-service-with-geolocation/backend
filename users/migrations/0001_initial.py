# Generated by Django 3.2.16 on 2023-09-12 19:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(help_text='Введите номер телефона', max_length=12, validators=[django.core.validators.RegexValidator('^+[0-9]{11}$', 'Используйте цифры от 0 до 9, начинайте ввод с +7')], verbose_name='Номер телефона')),
